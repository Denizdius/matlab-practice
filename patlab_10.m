...
up_time = linspace(0,1,length(upsampled_signal));
down_time = linspace(0,1,length(downsampled_signal));
...
subplot(2,2,3);
stem(down_time,dft_of_downsample);
title("DFT of downsample")

subplot(2,2,4);
stem(uptime,dft_of_upsample);
